    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Routa Profe -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('profes')" :active="request()->routeIs('profes')">
                        {{ __('Profes') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Ruta Pagar Mensualidad de la App -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pagarapp')" :active="request()->routeIs('pagarapp')">
                        {{ __('Pagar Mes') }}
                    </x-nav-link>
                </div>
